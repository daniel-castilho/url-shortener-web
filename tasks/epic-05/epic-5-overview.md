...
1. App shell: header with product name, Nav, user greeting, Sair — same on every route.
...
5. Mobile-first: fields full width; Mais and Copiar are thumb-reachable; nav wraps.
